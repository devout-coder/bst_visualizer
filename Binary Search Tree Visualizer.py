...
class BST:
    ...
    def make_instructional_buttons(self):# For make Instructional buttons
        ...
        self.in_order_traversal = Button(make_label_frame_for_traversing, text="In-order", font=("Arial", 15, "bold"),bg="black", fg="#00FF00", relief=RAISED, bd=8, command=lambda: self.traversing_decision_making(2), state=NORMAL)
