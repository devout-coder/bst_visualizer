...
class BST:
    def __init__(self, root):
        ...
        self.make_canvas = Canvas(self.window,width=1160,height=520,bg="white",relief=RAISED,bd=8)
    ...
    def heading_root_and_null_make(self):# By default window presentation
        make_heading = Label(self.make_canvas,text="Binary Search Tree Visualizer",font=("Arial",27,"bold","italic"),fg="blue",bg="white")
        ...
        self.make_null = Label(self.make_canvas,text="NULL",font=("Arial",17,"bold","italic"),fg="#2E37FE",bg="white")
        self.make_null.place(x=565,y=90+50)

    def make_instructional_buttons(self):# For make Instructional buttons
        self.insert_node = Button(self.window,text="Insert",font=("Arial",20,"bold"),bg="black",fg="violet",relief=RAISED,bd=8,command=lambda: self.take_input_set_up(1),state=NORMAL)
        self.insert_node.place(x=1210,y=10)

        self.make_delete = Button(self.window, text="Delete", font=("Arial", 20, "bold"), bg="black", fg="violet", relief=RAISED, bd=8, command=lambda: self.take_input_set_up(2), state=NORMAL)
        self.make_delete.place(x=1210,y=70)

        make_label_frame_for_traversing = LabelFrame(self.window,text="Traversing",width=50,bg="white",font=("Arial",13,"bold"),fg="green")
        make_label_frame_for_traversing.place(x=1183,y=280)

        self.pre_order_traversal  = Button(make_label_frame_for_traversing,text="Pre-order",font=("Arial",15,"bold"),bg="black",fg="violet",relief=RAISED,bd=8,command=lambda: self.traversing_decision_making(1),state=NORMAL)
        self.pre_order_traversal.pack(padx=10,pady=5)

        self.in_order_traversal = Button(make_label_frame_for_traversing, text="In-order", font=("Arial", 15, "bold"),bg="black", fg="violet", relief=RAISED, bd=8, command=lambda: self.traversing_decision_making(2), state=NORMAL)
        self.in_order_traversal.pack(padx=10, pady=5)

        self.post_order_traversal = Button(make_label_frame_for_traversing, text="Post-order", font=("Arial", 15, "bold"), bg="black", fg="violet", relief=RAISED, bd=8, command=lambda: self.traversing_decision_making(3), state=NORMAL)
    ...
    def take_input_set_up(self,indicator):# Set up for take input value for node insert and delete
        ...
        self.add_btn.place(x=1280, y=170)
    ...
    def decision_making_about_left_side_direction(self):
        try:
            ...
            make_greater_than_label = Label(self.window, text=">", fg="green", bg="white", font=("Arial", 20, "bold"))
    ...
    def decision_making_about_right_side_direction(self):
        try:
            self.right_activate = 1
            self.left_activate = 0
            make_less_than_label = Label(self.window, text="<", fg="green", bg="white", font=("Arial", 20, "bold"))
    ...
    def make_container_in_result_canvas(self):# In down canvas
        ...
        for i in range(15):
            ...
            self.value_show[i] = Label(self.result_canvas,bg="white",fg="black",text=" ",width="4",height="1",font=("Arial",15,"bold","italic"),relief=SUNKEN,bd=5)
...
if __name__ == '__main__':
    ...
    window.maxsize(1350,650)
    window.minsize(1350,650)
